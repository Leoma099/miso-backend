...
class EquipmentController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        // Validate file type
        $request->validate([
            'file' => 'required|file', // Allow CSV, XLSX, TXT files
        ]);
    ...
    {
        return Excel::download(new EquipmentExport, 'equipment-list.csv', \Maatwebsite\Excel\Excel::CSV);
    }

    // Track Equipment
    public function trackEquipment()
    {
